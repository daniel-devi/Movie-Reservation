...
SECRET_KEY = config('SECRET_KEY', default="JrWG_lSlDUUVweiHmwfYb2Mp5fq7Ylm8lzJFANxVDyyxfFkMI8nkXUSf9uHlwrmwJNc")
...
INSTALLED_APPS = [
    ...
    # add more apps here
    'multiselectfield', # Django MultiSelectField - Django field for multiple select fields
]
...
WSGI_APPLICATION = 'Movy.wsgi.application'
